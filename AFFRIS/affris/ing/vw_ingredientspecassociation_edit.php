...
$templatefile = "vw_ingredientspecassociation_edit.htm";
...
//	processing SpeciesID - end
//	processing SpecName - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing Hybrid - end
//	processing Variety - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing Variety - end
//	processing Family - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing Genus - end
//	processing Environment - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing Environment - end
//	processing FeedHabit - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing SpecYear - end
//	processing lower - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
//	processing lower - end
//	processing upper - begin
	$condition = $inlineedit!=EDIT_INLINE;//(!$inlineedit) edit simple mode
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: vw_ingredientspecassociation_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_vw_ingredientspecassociation->Copy();
...
if(!$data)
{
	...
	{
		header("Location: vw_ingredientspecassociation_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($readevalues)
{
	...
	$data["lower"] = $evalues["lower"];
	$data["upper"] = $evalues["upper"];
}
