...
//	IName - 
			$value="";
				$value=DisplayLookupWizard("IName",$data["IName"],$data,$keylink,MODE_PRINT);
...
//	Description2 - 
			$value="";
				$value=DisplayLookupWizard("Description2",$data["Description2"],$data,$keylink,MODE_PRINT);
			$xt->assign("Description2_mastervalue",$value);

//	Description3 - 
			$value="";
				$value=DisplayLookupWizard("Description3",$data["Description3"],$data,$keylink,MODE_PRINT);
...
//	IngredientClass - 
			$value="";
				$value = ProcessLargeText(GetData($data,"IngredientClass", ""),"field=IngredientClass".$keylink,"",MODE_PRINT);
			$xt->assign("IngredientClass_mastervalue",$value);
	$xt->display("vw_ingredientclass_masterprint.htm");
	$strTableName=$oldTableName;
