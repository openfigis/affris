...
$arr = array();
$arr['fName'] = "EName";
$arr['viewFormat'] = ViewFormat("EName", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "TagName";
$arr['viewFormat'] = ViewFormat("TagName", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Description";
$arr['viewFormat'] = ViewFormat("Description", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "IValue";
$arr['viewFormat'] = ViewFormat("IValue", $strTableName);
$fieldsArr[] = $arr;
...
//EName - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"EName", ""),"","",MODE_VIEW);
	$xt->assign("EName_value",$value);
...
//TagName - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"TagName", ""),"","",MODE_VIEW);
	$xt->assign("TagName_value",$value);
...
//IValue - Number
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"IValue", "Number"),"","",MODE_VIEW);
	$xt->assign("IValue_value",$value);
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='vw_fullingredientelementanalysis_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='vw_fullingredientelementanalysis_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_fullingredientelementanalysis_view.htm";
