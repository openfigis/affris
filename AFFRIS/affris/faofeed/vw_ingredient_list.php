...
//-----------Ingredient proximate analysis details special case--------------
//"select FisDetail from vw_feedingredient where fname=$fname and fisdetail = 1"
$ta_vble=GetFieldIndex("FeedID");
$result = mysql_query("select IisDetail from vw_feedingredient where feedid='$ta_vble' and iisdetail = 1",$conn);
$num_rows = mysql_num_rows($result);
if($num_rows==0){
	$allow_vw_fullingredientelementanalysis=false;
}
else{
...
$num_rows = mysql_num_rows($result);
if($num_rows==0){
	$allow_vw_fullingredientproxanalysis=false;
}
else{
