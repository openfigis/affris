...
$jscode.="
	document.forms.editform.value_Details.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_Details,'advanced')};
	document.forms.editform.value1_Details.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_Details,'advanced1')};
	document.forms.editform.value_Details.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_Details,'advanced')};
	document.forms.editform.value1_Details.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_Details,'advanced1')};
";
...
{
	$opt=@$where[$strTableName."_asearchopt"]["Details"];
	$not=@$where[$strTableName."_asearchnot"]["Details"];
	$control_Details["params"]["value"]=@$where[$strTableName."_asearchfor"]["Details"];
}
$control_Details["func"]="xt_buildeditcontrol";
$control_Details["params"]["field"]="Details";
$control_Details["params"]["mode"]="search";
$xt->assignbyref("Details_editcontrol",$control_Details);
$control1_Details=$control_Details;
$control1_Details["params"]["second"]=true;
if(@$where[$strTableName."_search"]==2)
	$control1_Details["params"]["value"]=@$where[$strTableName."_asearchfor2"]["Details"];
$xt->assignbyref("Details_editcontrol1",$control1_Details);
	
$xt->assign_section("Details_fieldblock","<input type=\"Hidden\" name=\"asearchfield[]\" value=\"Details\">","");
$notbox_Details="name=\"not_Details\"";
if($not)
	$notbox_Details=" checked";
$xt->assign("Details_notbox",$notbox_Details);
...
$searchtype .= $options;
$searchtype .= "</SELECT>";
$xt->assign("searchtype_Details",$searchtype);
//	edit format
$editformats["Details"]="Text field";
// Feed 
$opt="";
$not=false;
$control_Feed=array();
