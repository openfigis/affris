...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchByField = ($searchField == '' || $searchField=="AntiFactor");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="ToxicLevel");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="Treatment");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="PartUsed");
	if($searchByField)
	{
