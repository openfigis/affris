...
//	FValue - Number
	$value="";
		$value = ProcessLargeText(GetData($data,"FValue", "Number"),"","",MODE_VIEW);
	$xt->assign("FValue_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_feedingredient_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_feedingredient_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_feedingredient_view.htm";
if(!$all)
{
