...
//	DValue - Number
	$value="";
		$value = ProcessLargeText(GetData($data,"DValue", "Number"),"","",MODE_VIEW);
	$xt->assign("DValue_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_digestibility_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_digestibility_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_digestibility_view.htm";
if(!$all)
{
