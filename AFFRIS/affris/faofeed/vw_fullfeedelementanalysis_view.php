...
//	UnitName - 
	$value="";
		$value = ProcessLargeText(GetData($data,"UnitName", ""),"","",MODE_VIEW);
	$xt->assign("UnitName_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_fullfeedelementanalysis_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_fullfeedelementanalysis_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_fullfeedelementanalysis_view.htm";
if(!$all)
{
