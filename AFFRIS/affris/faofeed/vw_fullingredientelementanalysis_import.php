...
$xt = new Xtempl();
$body=array();
$body["begin"]="<FORM name=frmimport id=frmimport action=\"vw_fullingredientelementanalysis_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='vw_fullingredientelementanalysis_list.php?a=return';\"");
$xt->assign("error_message",$error_message);
$xt->display("vw_fullingredientelementanalysis_import.htm");
