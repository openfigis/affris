...
//	Group - 
	$value="";
		$value=DisplayLookupWizard("Group",$data["Group"],$data,$keylink,MODE_VIEW);
...
//	FeedHabit - 
	$value="";
		$value=DisplayLookupWizard("FeedHabit",$data["FeedHabit"],$data,$keylink,MODE_VIEW);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_species_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_species_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_species_view.htm";
if(!$all)
{
