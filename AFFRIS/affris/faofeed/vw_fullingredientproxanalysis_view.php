...
//	UnitSymbol - 
	$value="";
		$value = ProcessLargeText(GetData($data,"UnitSymbol", ""),"","",MODE_VIEW);
	$xt->assign("UnitSymbol_value",$value);
	$xt->assign("UnitSymbol_fieldblock",true);
////////////////////////////////////////////
//	UnitDecimal - 
	$value="";
		$value = ProcessLargeText(GetData($data,"UnitDecimal", ""),"","",MODE_VIEW);
	$xt->assign("UnitDecimal_value",$value);
	$xt->assign("UnitDecimal_fieldblock",true);
////////////////////////////////////////////
//	ETValue - Number
	$value="";
		$value = ProcessLargeText(GetData($data,"ETValue", "Number"),"","",MODE_VIEW);
	$xt->assign("ETValue_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_fullingredientproxanalysis_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_fullingredientproxanalysis_view.php?".$prevlink."'\"");
	}
    else 
