...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchByField =  (($searchField == '' || $searchField=="ElementTypeID")&&(postvalue("searchType")!="ordinary"));
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="UnitName");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="UnitSymbol");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="UnitDecimal");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="ETValue");
	if($searchByField)
	{
