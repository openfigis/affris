...
//	FName - 
	$value="";
		$value = ProcessLargeText(GetData($data,"FName", ""),"","",MODE_VIEW);
	$xt->assign("FName_value",$value);
	$xt->assign("FName_fieldblock",true);
////////////////////////////////////////////
//	BrandName - 
	$value="";
		$value = ProcessLargeText(GetData($data,"BrandName", ""),"","",MODE_VIEW);
	$xt->assign("BrandName_value",$value);
...
//	FeedYear - 
	$value="";
		$value = ProcessLargeText(GetData($data,"FeedYear", ""),"","",MODE_VIEW);
	$xt->assign("FeedYear_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_feed_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_feed_view.php?".$prevlink."'\"");
	}
    else 
