...
if($inlineedit==ADD_INLINE)
	$templatefile = "vw_fullfeedelementanalysis_inline_add.htm";
else
	$templatefile = "vw_fullfeedelementanalysis_add.htm";
...
if (no_output_done() && $inlineedit==ADD_SIMPLE && $IsSaved){
	...
	// redirect
	header("Location: vw_fullfeedelementanalysis_".$pageName);
...
if($inlineedit!=ADD_INLINE)
{
	...
	{
		$body["begin"]=$includes.
		"<form name=\"editform\" id=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"vw_fullfeedelementanalysis_add.php\" ".$onsubmit.">".
	...
	else
	{
		...
		$body["begin"]="<form name=\"editform".$id."\" id=\"editform".$id."\" encType=\"multipart/form-data\" method=\"post\" action=\"vw_fullfeedelementanalysis_add.php\" ".$onsubmit." target=\"flyframe".$id."\">".
		"<input type=hidden name=\"a\" value=\"added\">".
