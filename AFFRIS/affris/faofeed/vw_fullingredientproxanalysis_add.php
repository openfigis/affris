...
if (no_output_done() && $inlineedit==ADD_SIMPLE && $IsSaved){
	...
	// redirect
	header("Location: vw_fullingredientproxanalysis_".$pageName);
...
if($inlineedit!=ADD_INLINE)
{
	...
	{
		$body["begin"]=$includes.
		"<form name=\"editform\" id=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"vw_fullingredientproxanalysis_add.php\" ".$onsubmit.">".
	...
	else
	{
		...
		$body["begin"]="<form name=\"editform".$id."\" id=\"editform".$id."\" encType=\"multipart/form-data\" method=\"post\" action=\"vw_fullingredientproxanalysis_add.php\" ".$onsubmit." target=\"flyframe".$id."\">".
		"<input type=hidden name=\"a\" value=\"added\">".
