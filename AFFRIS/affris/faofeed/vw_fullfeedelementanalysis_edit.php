...
$templatefile = "vw_fullfeedelementanalysis_edit.htm";
...
if ($IsSaved && no_output_done() && !$inlineedit )
{
	...
	// redirect
	header("Location: vw_fullfeedelementanalysis_".$pageName."?".$keyGetQ);
...
if(!$data)
{
	if(!$inlineedit)
	{
		header("Location: vw_fullfeedelementanalysis_list.php?a=return");
		exit();
	}
	else
		$data=array();
...
if(!$inlineedit)
{
	...
	$body["begin"]=$includes."
	<form name=\"editform\" id=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"vw_fullfeedelementanalysis_edit.php\" ".$onsubmit.">".
...
//create a line where and order for the two queries
	...
	if(count($next))
	{
		...
		$xt->assign("nextbutton_attrs","align=\"absmiddle\" onclick=\"window.location.href='vw_fullfeedelementanalysis_edit.php?".$nextlink."'\"");
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","align=\"absmiddle\" onclick=\"window.location.href='vw_fullfeedelementanalysis_edit.php?".$prevlink."'\"");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
	$xt->assign("backbutton_attrs","onclick=\"window.location.href='vw_fullfeedelementanalysis_list.php?a=return'\"");
...
$control_ElementID["params"]["value"]=@$data["ElementID"];

$control_ElementID["params"]["id"]=$record_id;
if($inlineedit)
	$control_ElementID["params"]["mode"]="inline_edit";
else
	$control_ElementID["params"]["mode"]="edit";
...
$control_EName["params"]["value"]=@$data["EName"];

$control_EName["params"]["id"]=$record_id;
if($inlineedit)
	$control_EName["params"]["mode"]="inline_edit";
else
	$control_EName["params"]["mode"]="edit";
...
$control_TagName["params"]["value"]=@$data["TagName"];

$control_TagName["params"]["id"]=$record_id;
if($inlineedit)
	$control_TagName["params"]["mode"]="inline_edit";
else
	$control_TagName["params"]["mode"]="edit";
...
$control_iValue["params"]["value"]=@$data["iValue"];

$control_iValue["params"]["id"]=$record_id;
if($inlineedit)
	$control_iValue["params"]["mode"]="inline_edit";
else
	$control_iValue["params"]["mode"]="edit";
