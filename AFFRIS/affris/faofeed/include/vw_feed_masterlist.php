...
//	FName - 
			$value="";
				$value = ProcessLargeText(GetData($data,"FName", ""),"field=FName".$keylink);
			$xt->assign("FName_mastervalue",$value);

//	BrandName - 
			$value="";
				$value = ProcessLargeText(GetData($data,"BrandName", ""),"field=BrandName".$keylink);
...
//	FeedYear - 
			$value="";
				$value = ProcessLargeText(GetData($data,"FeedYear", ""),"field=FeedYear".$keylink);
...
//	CountryOrigin - 
			$value="";
				$value = ProcessLargeText(GetData($data,"CountryOrigin", ""),"field=CountryOrigin".$keylink);
			$xt->assign("CountryOrigin_mastervalue",$value);

//	FDataSource - 
			$value="";
				$value = ProcessLargeText(GetData($data,"FDataSource", ""),"field=FDataSource".$keylink);
			$xt->assign("FDataSource_mastervalue",$value);

//	FeedType - 
			$value="";
				$value = ProcessLargeText(GetData($data,"FeedType", ""),"field=FeedType".$keylink);
			$xt->assign("FeedType_mastervalue",$value);
	$strTableName=$oldTableName;
	$xt->display("vw_feed_masterlist.htm");
}
