...
//	Feed - 
			$value="";
				$value=DisplayLookupWizard("Feed",$data["Feed"],$data,$keylink,MODE_LIST);
			$xt->assign("Feed_mastervalue",$value);

//	Brand - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Brand", ""),"field=Brand".$keylink);
			$xt->assign("Brand_mastervalue",$value);

//	Technology - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Technology", ""),"field=Technology".$keylink);
			$xt->assign("Technology_mastervalue",$value);

//	Feed Year - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Feed Year", ""),"field=Feed+Year".$keylink);
			$xt->assign("Feed_Year_mastervalue",$value);

//	Stage - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Stage", ""),"field=Stage".$keylink);
			$xt->assign("Stage_mastervalue",$value);

//	Country Origin - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Country Origin", ""),"field=Country+Origin".$keylink);
			$xt->assign("Country_Origin_mastervalue",$value);

//	Details - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Details", ""),"field=Details".$keylink);
			$xt->assign("Details_mastervalue",$value);

//	Data Source - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Data Source", ""),"field=Data+Source".$keylink);
...
//	Species Name - 
			$value="";
				$value=DisplayLookupWizard("Species Name",$data["Species Name"],$data,$keylink,MODE_LIST);
			$xt->assign("Species_Name_mastervalue",$value);

//	Common Name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Common Name", ""),"field=Common+Name".$keylink);
			$xt->assign("Common_Name_mastervalue",$value);

//	Hybrid - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Hybrid", ""),"field=Hybrid".$keylink);
			$xt->assign("Hybrid_mastervalue",$value);

//	Variety - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Variety", ""),"field=Variety".$keylink);
			$xt->assign("Variety_mastervalue",$value);

//	Family - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Family", ""),"field=Family".$keylink);
			$xt->assign("Family_mastervalue",$value);

//	Group - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Group", ""),"field=Group".$keylink);
			$xt->assign("Group_mastervalue",$value);

//	Genus - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Genus", ""),"field=Genus".$keylink);
			$xt->assign("Genus_mastervalue",$value);

//	Environment - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Environment", ""),"field=Environment".$keylink);
			$xt->assign("Environment_mastervalue",$value);

//	Habit - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Habit", ""),"field=Habit".$keylink);
			$xt->assign("Habit_mastervalue",$value);

//	Country - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Country", ""),"field=Country".$keylink);
			$xt->assign("Country_mastervalue",$value);

//	Species Year - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Species Year", ""),"field=Species+Year".$keylink);
			$xt->assign("Species_Year_mastervalue",$value);
	$strTableName=$oldTableName;
	$xt->display("vw_feedspec_masterlist.htm");
}
