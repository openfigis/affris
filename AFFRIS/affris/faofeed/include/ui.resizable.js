...
;(function($) {
	...
	$.widget("ui.resizable", {
		init: function() {
			...
			//Default Theme
			var aBorder = '1px solid #434343';
	
			o.defaultTheme = {
				'ui-resizable': { display: 'block' },
				'ui-resizable-handle': { position: 'absolute', background: '#F2F2F2', fontSize: '0.1px' },
				'ui-resizable-n': { cursor: 'n-resize', height: '4px', left: '0px', right: '0px', borderTop: aBorder },
				'ui-resizable-s': { cursor: 's-resize', height: '4px', left: '0px', right: '0px', borderTop: aBorder },
				'ui-resizable-e': { cursor: 'e-resize', width: '4px', top: '23px', bottom: '0px', borderLeft: aBorder },
				'ui-resizable-w': { cursor: 'w-resize', width: '4px', top: '23px', bottom: '0px', borderRight: aBorder },
			...
			o.knobTheme = {
				'ui-resizable-handle': { background: '#F2F2F2', border: '1px solid #808080', height: '5px', width: '5px' },
