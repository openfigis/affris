...
//	IName - 
			$value="";
				$value = ProcessLargeText(GetData($data,"IName", ""),"field=IName".$keylink);
...
//	Description2 - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Description2", ""),"field=Description2".$keylink);
			$xt->assign("Description2_mastervalue",$value);

//	Description3 - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Description3", ""),"field=Description3".$keylink);
...
//	Species - 
	...
	$strTableName=$oldTableName;
	$xt->display("vw_ingredient_masterlist.htm");
}
