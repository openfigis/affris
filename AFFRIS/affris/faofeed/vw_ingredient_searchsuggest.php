...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchByField = ($searchField == '' || $searchField=="IfeedNo");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="Description1");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="Description2");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="Description3");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="ICountry");
	if($searchByField)
	{
	...
	$searchByField = ($searchField == '' || $searchField=="Species");
	if($searchByField)
	{
