...
//	AntiFactor - 
	$value="";
		$value = ProcessLargeText(GetData($data,"AntiFactor", ""),"","",MODE_VIEW);
...
//	PartUsed - 
	$value="";
		$value = ProcessLargeText(GetData($data,"PartUsed", ""),"","",MODE_VIEW);
	$xt->assign("PartUsed_value",$value);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='vw_antinutritional_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='vw_antinutritional_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "vw_antinutritional_view.htm";
if(!$all)
{
